...
public class ReadFile : MonoBehaviour
{
    ...
    public List<int> tetHighEdgeIds = new List<int>();
    ...
    void ReadElefile()
    {
        //string filePath = "E:/tetgen/tetgen-master/vs/tetgen/Debug/ceshi_dannang.1.ele";//高模的
    ...
    void ReadNodeFile()
    {
        ...
        //string filePath = "C:/Users/GMJ/Desktop/三维模型/unity/测试低模控制高模/lowDannang.1.node";//低模的
    ...
    void ReadEdgeFile()
    {
        //string edgeFilePath = "E:/tetgen/tetgen-master/vs/tetgen/Debug/Low.1.edge";
    ...
    void ReadHighEdgeFile()
    {
        ...
        using (StreamReader file = new StreamReader(edgeFilePath))
        {
            ...
            int eNum = int.Parse(strings[0]);
            tetHighEdgeIds.Capacity = eNum * 2;

            for (int i = 0; i < eNum; ++i)
            {
                tetHighEdgeIds.Add(int.Parse(strings[i * 4 + 3]));
                tetHighEdgeIds.Add(int.Parse(strings[i * 4 + 4]));
            }
        }
        //Debug.Log(tetEdgeIds.Count);
    }
